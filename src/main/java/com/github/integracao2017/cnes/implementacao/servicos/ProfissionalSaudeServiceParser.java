			...
			for (int i = 0; i < nodeList.getLength(); i++) {
				...
				if (node.getNodeType() == Node.ELEMENT_NODE) {
					...
					parser(ProfissionalSaudeService.PROF_COD_IDENTIFICADOR_EMAIL, eElement,
							"http://servicos.saude.gov.br/schema/corporativo/v1r2/email", "Email",
							"http://servicos.saude.gov.br/schema/cnes/v1r0/codigocnes", "identificador");
					
					parser(ProfissionalSaudeService.PROF_DESC_EMAIL, eElement,
							"http://servicos.saude.gov.br/schema/corporativo/v1r2/email", "Email",
							"http://servicos.saude.gov.br/schema/cnes/v1r0/codigocnes", "descricaoEmail");
					
					parser(ProfissionalSaudeService.PROF_TIPO_EMAIL, eElement,
							"http://servicos.saude.gov.br/schema/corporativo/v1r2/email", "Email",
							"http://servicos.saude.gov.br/schema/cnes/v1r0/codigocnes", "tipoEmail");
					
					parser(ProfissionalSaudeService.PROF_EMAIL_VALIDADO, eElement,
							"http://servicos.saude.gov.br/schema/corporativo/v1r2/email", "Email",
							"http://servicos.saude.gov.br/schema/cnes/v1r0/codigocnes", "validado");
